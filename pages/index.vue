  ...
  <section>
    ...
    <div v-if="$device.isDesktop">
      <main class="flex flex-wrap justify-center">
        ...
        <template v-else>
          <div
            v-for="data in getPaginationItems"
            :key="data.vid"
            class="md:px-2 lg:px-2 xl:px-2 2xl:px-2 lg:mt-8 xl:mt-8 2xl:mt-8"
          >
            <vue-lazy-component>
...
export default Vue.extend({
  ...
  computed: {
    ...
    getJapaneseItems(): number {
      // @ts-ignore
      return this.messages.slice().sort(function () {
    ...
    getPaginationItems(): number {
      ...
      return this.messages.slice(start, current).sort(function () {
        return Math.random() - 0.5
      })
    },
...
<!-- <template>
  <div class=">
    ...
    <template v-else>
      <h1 class="text-gray-100 text-2xl font-semibold ml-6 pt-8">
        日本で急上昇
      </h1>
        ...
        <div v-for="data in soaringMessages" :key="data.id" class="p-4">
          <nuxt-link :to="{ path: 'embedded_url' + '/' + data.vid }">
            <div class="relative">
              ...
              />
              <h5 class="text-gray-100 z-10 absolute right-0 bottom-0">
                {{ toHms(data.duration) }}
              </h5>
            </div>
  ...
  <section>
    <div v-if="$device.isDesktop">
      <div
        ...
        style="height: 768px"
      >
        <img src="~/assets/Porngle.jpeg" alt="Porngle" class="w-40" />
      </div>
    </div>
    <div v-else>
      <div
